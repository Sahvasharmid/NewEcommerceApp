  ...
  e.preventDefault()
      try {
       ...
       photo &&  productData.append("photo", photo);
        ...
        const {data} = await axios.put(`http://localhost:8080/updateproduct/${id}`,
          productData
...
const handleDelete=async()=>{
  try {
    const { data } = await axios.delete(`http://localhost:8080/deleteproduct/${id}`);
 ...
 style={{ width: '100%' }}
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`http://localhost:8080/getproductphoto/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
